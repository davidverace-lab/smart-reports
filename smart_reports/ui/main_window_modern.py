...
class MainWindow:
    ...
    def show_actualizar_panel(self):
        ...
        if DRAG_DROP_AVAILABLE:
            try:
                ...
                print(f"Warning: No se pudo inicializar drag & drop: {e}")
    ...
    def show_consultas_panel(self):
        ...
        self.advanced_filters_frame = ctk.CTkFrame(search_card, fg_color='#1a1d2e', corner_radius=10)
        ...
        # Separador
        sep3 = ctk.CTkFrame(search_card, height=1, fg_color='#3a3d5c')
    ...
    def show_configuracion_panel(self):
        ...
        # Definir PRIMARY_COLORS para consistencia
        PRIMARY_COLORS = {
            'accent_blue': '#6c63ff',
            'accent_green': '#51cf66',
